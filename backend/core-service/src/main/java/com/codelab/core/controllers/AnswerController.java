...
import com.codelab.core.dto.AnswerCreateRequest;
import com.codelab.core.entities.Answer;
import com.codelab.core.repositories.UserRepository;
import com.codelab.core.services.AnswerService;
...
public class AnswerController {
    ...
    @GetMapping("/user/{id}")
    @PreAuthorize("hasAuthority('ADMIN') or @userRepository.findById(#id).orElse(new com.codelab.core.entities.User()).email == authentication.name")
